...
RUN bash -c 'curl -fsSL https://deb.nodesource.com/setup_20.x | bash - &&'; \
    ...
    /home/linuxbrew/.linuxbrew/bin/brew install tctl go --ignore-dependencies; \
    ...
    # mv /home/linuxbrew/.linuxbrew /opt/homebrew; \
    curl -sSf https://temporal.download/cli.sh | sh; \
    echo "PATH=/root/.temporalio/bin:/home/linuxbrew/.linuxbrew/bin:$PATH" >> /etc/bash.bashrc; \
